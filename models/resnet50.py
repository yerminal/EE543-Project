...
default_cfgs = dict(
    resnet50_tiny=_cfg(url="https://dl.fbaipublicfiles.com/resnet50/resnet50_tiny_1k_224_ema.pth"),
    resnet50_small=_cfg(url="https://dl.fbaipublicfiles.com/resnet50/resnet50_small_1k_224_ema.pth"),
    resnet50_base=_cfg(url="https://dl.fbaipublicfiles.com/resnet50/resnet50_base_1k_224_ema.pth"),
    resnet50_large=_cfg(url="https://dl.fbaipublicfiles.com/resnet50/resnet50_large_1k_224_ema.pth"),

    resnet50_tiny_hnf=_cfg(url=''),

    resnet50_base_in22ft1k=_cfg(
        url='https://dl.fbaipublicfiles.com/resnet50/resnet50_base_22k_1k_224.pth'),
    resnet50_large_in22ft1k=_cfg(
        url='https://dl.fbaipublicfiles.com/resnet50/resnet50_large_22k_1k_224.pth'),
    resnet50_xlarge_in22ft1k=_cfg(
        url='https://dl.fbaipublicfiles.com/resnet50/resnet50_xlarge_22k_1k_224_ema.pth'),

    resnet50_base_384_in22ft1k=_cfg(
        url='https://dl.fbaipublicfiles.com/resnet50/resnet50_base_22k_1k_384.pth',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0),
    resnet50_large_384_in22ft1k=_cfg(
        url='https://dl.fbaipublicfiles.com/resnet50/resnet50_large_22k_1k_384.pth',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0),
    resnet50_xlarge_384_in22ft1k=_cfg(
        url='https://dl.fbaipublicfiles.com/resnet50/resnet50_xlarge_22k_1k_384_ema.pth',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0),

    resnet50_base_in22k=_cfg(
        url="https://dl.fbaipublicfiles.com/resnet50/resnet50_base_22k_224.pth", num_classes=21841),
    resnet50_large_in22k=_cfg(
        url="https://dl.fbaipublicfiles.com/resnet50/resnet50_large_22k_224.pth", num_classes=21841),
    resnet50_xlarge_in22k=_cfg(
        url="https://dl.fbaipublicfiles.com/resnet50/resnet50_xlarge_22k_224.pth", num_classes=21841),
)
...
class resnet50Stage(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = nn.Sequential(*[resnet50Block(
...
class resnet50(nn.Module):
    ...
    def __init__(
        ...
        if head_norm_first:
            ...
            # pool -> norm -> fc, the default resnet50 ordering (pretrained FB weights)
...
def _create_resnet50(variant, pretrained=False, **kwargs):
    model = build_model_with_cfg(
        resnet50, variant, pretrained,
...
@register_model
def resnet50_tiny(pretrained=False, **kwargs):
    model_args = dict(depths=(3, 3, 9, 3), dims=(96, 192, 384, 768), **kwargs)
    model = _create_resnet50('resnet50_tiny', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_tiny_hnf(pretrained=False, **kwargs):
    model_args = dict(depths=(3, 3, 9, 3), dims=(96, 192, 384, 768), head_norm_first=True, **kwargs)
    model = _create_resnet50('resnet50_tiny_hnf', pretrained=pretrained, **model_args)
    return model
...
def resnet50_small(pretrained=False, **kwargs):
    ...
    model = _create_resnet50('resnet50_small', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_base(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], **kwargs)
    model = _create_resnet50('resnet50_base', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_large(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], **kwargs)
    model = _create_resnet50('resnet50_large', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_base_in22ft1k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], **kwargs)
    model = _create_resnet50('resnet50_base_in22ft1k', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_large_in22ft1k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], **kwargs)
    model = _create_resnet50('resnet50_large_in22ft1k', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_xlarge_in22ft1k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[256, 512, 1024, 2048], **kwargs)
    model = _create_resnet50('resnet50_xlarge_in22ft1k', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_base_384_in22ft1k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], **kwargs)
    model = _create_resnet50('resnet50_base_384_in22ft1k', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_large_384_in22ft1k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], **kwargs)
    model = _create_resnet50('resnet50_large_384_in22ft1k', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_xlarge_384_in22ft1k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[256, 512, 1024, 2048], **kwargs)
    model = _create_resnet50('resnet50_xlarge_384_in22ft1k', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_base_in22k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], **kwargs)
    model = _create_resnet50('resnet50_base_in22k', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_large_in22k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], **kwargs)
    model = _create_resnet50('resnet50_large_in22k', pretrained=pretrained, **model_args)
    return model


@register_model
def resnet50_xlarge_in22k(pretrained=False, **kwargs):
    model_args = dict(depths=[3, 3, 27, 3], dims=[256, 512, 1024, 2048], **kwargs)
    model = _create_resnet50('resnet50_xlarge_in22k', pretrained=pretrained, **model_args)
    return model
